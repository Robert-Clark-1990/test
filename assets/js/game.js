...
function selectOption(option) {
    ...
    if (nextTextNodeId <= 0) {
        return startGame();
    } else if (state == {BjornPleased: true, AstridPleased: true}) {
        return GameComplete();
    }
...
// ------------------------------------------------------ Talk To Functions
    ...
    },
    {
        ...
        options: [
            {   text: "Yes",    setState: { AstridPleased: true },   nextText: 1,   },
        ]
    },
    {
        id: 7,
        ...
        options: [
            {   text: "Yes",    setState: { BjornPleased: true },   nextText: 1,    },
        ]
    },
    {
        id: 300,
        text: "Game Complete",
        dialogue: "Yay you did it!",
        options: [
            {   text: "Yes",    nextText: 1,    },
        ]
    },
